			...
			Sets = new List<AchievementSet>()
				{
					...
					new AchievementPredicate(AchievementID.Backtracking, () => InputManager.GetCommand("Left")),
					new AchievementPredicate(AchievementID.Progress, () => InputManager.GetCommand("Right")),
					new AchievementFamily(new List<AchievementFamilyRegistration>()
						{
